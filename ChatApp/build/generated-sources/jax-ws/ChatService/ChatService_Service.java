 ...
 * 
 */
@WebServiceClient(name = "ChatService", targetNamespace = "http://ChatService/", wsdlLocation = "http://localhost:8080/ChatAppServerProject/ChatService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName CHATSERVICE_QNAME = new QName("http://ChatService/", "ChatService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ChatAppServerProject/ChatService?wsdl");
    ...
    public ChatService getChatServicePort() {
        return super.getPort(new QName("http://ChatService/", "ChatServicePort"), ChatService.class);
    }
    ...
    public ChatService getChatServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://ChatService/", "ChatServicePort"), ChatService.class, features);
    }

 ...
 * 
 */
@WebServiceClient(name = "UserService", targetNamespace = "http://UserService/", wsdlLocation = "http://localhost:8080/ChatAppServerProject/UserService?wsdl")
    ...
    extends Service
{
    ...
    private final static QName USERSERVICE_QNAME = new QName("http://UserService/", "UserService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/ChatAppServerProject/UserService?wsdl");
    ...
    public UserService getUserServicePort() {
        return super.getPort(new QName("http://UserService/", "UserServicePort"), UserService.class);
    }
    ...
    public UserService getUserServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://UserService/", "UserServicePort"), UserService.class, features);
    }
